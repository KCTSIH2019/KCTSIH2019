jQuery(function ($) {
	...
	// Count Time 
	function makeTimer() {
		var endTime = new Date("December 23, 2023 09:00:00 IST");		 
		//September 30, 2024 17:00:00 PDT	
		//December 30, 2024 17:00:00 PDT
	...
	// Count Time 
	function makeTimer() {
		var endTime = new Date("December 23, 2023 09:00:00 PDT");			 //December 30, 2024 17:00:00 PDT
		var endTime = (Date.parse(endTime)) / 1000;
		var now = new Date();
		var now = (Date.parse(now) / 1000);
		var timeLeft = endTime - now;
